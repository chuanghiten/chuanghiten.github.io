 ...
 */
  ...
  const getLunar = (dd, mm, yy, timeZone) => {
    let monthStart,
      a11,
      b11,
      lunarMonth,
  ...
  console.log(lunar_date, lunar_month, lunar_year, lunar_leap, `Ngày ${can[(jdFromDate(25, 7, 2025) + 9) % 10]} ${chi[(jdFromDate(25, 7, 2025) + 1) % 12]} Tháng ${can[((lunar_year * 12) + lunar_month + 3) % 10]} Năm`);
