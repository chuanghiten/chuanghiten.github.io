...
eval(
  (function (p, a, c, k, e, d) {
    ...
    "i o(u){p=u}G i h(t,s){g=F E(`${a[2]}${b[a[3]](t.r())}${a[4]}${b[a[3]](s.r())}${a[5]}`)[a[1]]((f)=>{D f[a[0]]()});e(g[a[6]]!=C||g[a[6]]!=B){A(g[a[7]],g[a[8]])}}i j(f){d=f[a[q]][a[9]];c=f[a[q]][a[z]];h(d,c)}i y(){e(p!=1){o(1);e(b[a[k]][a[x]]){e(d&&c){h(d,c)}l{b[a[k]][a[n]][a[m]](j)}}l{b[a[w]](a[v],()=>{e(d&&c){h(d,c)}l{b[a[k]][a[n]][a[m]](j)}})}}}",
    43,
    43,
