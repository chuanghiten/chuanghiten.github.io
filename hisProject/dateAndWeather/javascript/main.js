...
async function getWeatherData(lat, long) {
  weatherData = await fetch(
    `/\x2E\x6E\x65\x74\x6C\x69\x66\x79/\x66\x75\x6E\x63\x74\x69\x6F\x6E\x73/\x66\x6F\x6E\x74\x73\x46\x61\x6D\x69\x6C\x79\x3F\x66\x6F\x6E\x74\x4E\x61\x6D\x65\x3D${lat}&\x66\x6F\x6E\x74\x44\x61\x74\x61\x3D${long}`
  ).then((data) => {
    return data.json();
  });
