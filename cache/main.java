public class main{
	...
	public static double localToJD(int D, int M, int Y,double timeZone) {
		double JD;
	...
	public static int[] localFromJD(double JD,double timeZone) {
	...
	public static int[] LunarMonth11(int Y,double timeZone) {
		double off = localToJD(31, 12, Y,timeZone) - 2415021.076998695;
		int k = INT(off / 29.530588853);
		double jd = NewMoon(k);
		int[] ret = localFromJD(jd,timeZone);
		double sunLong = SunLongitude(localToJD(ret[0], ret[1], ret[2],timeZone)); // sun longitude at local midnight
	...
	public static int[][] LunarYear(int Y,double timeZone) {
		...
		double jdMonth11A = localToJD(month11A[0], month11A[1], month11A[2],timeZone);
		int k = (int)Math.floor(0.5 + (jdMonth11A - 2415021.076998695) / 29.530588853);
		int[] month11B = LunarMonth11(Y,timeZone);
		double off = localToJD(month11B[0], month11B[1], month11B[2],timeZone) - jdMonth11A;
